...
from model.active_elastic.genetic_algorithm_model_active_elastic_with_orientation_component import GeneticAlgorithmActiveElasticBasicWithParamsWithOrientationComponent
...
for i in range(num_iters):
    model = GeneticAlgorithmActiveElasticBasicWithParamsWithOrientationComponent(radius=radius, 
                        tmax=tmax, 
                        density=density, 
                        number_particles=n,
