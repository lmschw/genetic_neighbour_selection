...
if target_order == 1:
    postfix = f"_test_ga_order_n={n}_pi={prob_init}_pm={prob_mut}_pn={prob_intro}_g={num_gens}_pop={population_size}"
elif target_order == 0:
    postfix = f"_test_ga_disorder_n={n}_pi={prob_init}_pm={prob_mut}_pn={prob_intro}_g={num_gens}_pop={population_size}"
else:
    postfix = f"_test_ga_middle_n={n}_pi={prob_init}_pm={prob_mut}_pn={prob_intro}_g={num_gens}_pop={population_size}"
